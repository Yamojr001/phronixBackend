    ...
    return (
        <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-brand-light font-primary">
            ...
            <div className="w-full sm:max-w-md mt-6 px-10 py-12 bg-white shadow-2xl overflow-hidden sm:rounded-[2.5rem] text-center">
                <div className="w-20 h-20 bg-red-100 text-red-600 rounded-3xl flex items-center justify-center text-3xl mx-auto mb-8">
                    <i className="fas fa-user-slash"></i>
                </div>
                
                <h2 className="text-3xl font-black text-brand-dark tracking-tight uppercase mb-4">Account Deactivated</h2>
                
                <p className="text-gray-500 font-medium leading-relaxed mb-10">
                    Your Scholar account has been deactivated by the system administrator. 
            ...
            <p className="mt-8 text-xs font-bold text-gray-400 uppercase tracking-[0.3em]">
                Phronix AI Administrative Control
            </p>
        </div>
    );
}
